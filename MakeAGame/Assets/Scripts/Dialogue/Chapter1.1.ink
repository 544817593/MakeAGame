...
现在，*左键*拖拽你的调查员*弗朗西斯*登场！#speaker: 引导者 #control: 操作

瞧这个蠢货，他看起来迷了路。现在，*左键*拖拽他，为他指引前进的方向吧。#speaker: 引导者 #control: 操作
记住：每个【调查员】都是一场战斗的核心，他们能发挥出各种强大的力量影响战场。。#speaker: 引导者

他们的能力你可以将鼠标悬浮在其上看到，其余的你就要自己摸索了——喂！实习生！你有没有在认真听讲？。#speaker: 引导者

调查员是你最珍贵的朋友，只有让他们存活着探索完整个屋子，到达右上角的门时，你才算胜利，也就是——通关！#speaker: 引导者 #wait: 等

弗朗西斯看起来陷入了苦战。现在，*右键*拖拽你的卡牌放置过去。#speaker: 引导者 #control: 操作
